...
int main() {
    ...
    ofstream file("gcd_euclidean_recursive_results.csv");
    ...
    for (const auto& test : tests) {
        ...
        long long result = gcdRecursive(test.a, test.b);
    ...
    file.close();
    cout << "\n✅ CSV file 'gcd_euclidean_recursive_results.csv' generated successfully.\n";
    return 0;
}
