// GcdEuclideanRecursiveToCsv.java
...
public class GcdEuclideanRecursiveToCsv {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (PrintWriter writer = new PrintWriter(new FileWriter("gcd_euclidean_recursive_results.csv"))) {
        ...
        System.out.println("✅ CSV file 'gcd_euclidean_recursive_results.csv' generated successfully.");
    }
}
