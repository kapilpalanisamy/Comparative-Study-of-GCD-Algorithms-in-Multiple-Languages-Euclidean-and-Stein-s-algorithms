...
public class GcdBuiltinToCsv {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (PrintWriter writer = new PrintWriter(new FileWriter("gcd_builtin_results.csv"))) {
        ...
        System.out.println("✅ CSV file 'gcd_builtin_results.csv' generated successfully.");
    }
}
