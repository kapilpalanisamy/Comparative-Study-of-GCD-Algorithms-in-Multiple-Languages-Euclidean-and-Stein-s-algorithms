...
public class GcdSubtractionToCsv {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (PrintWriter writer = new PrintWriter(new FileWriter("gcd_subtraction_results.csv"))) {
        ...
        System.out.println("✅ CSV file 'gcd_subtraction_results.csv' generated successfully.");
    }
}
