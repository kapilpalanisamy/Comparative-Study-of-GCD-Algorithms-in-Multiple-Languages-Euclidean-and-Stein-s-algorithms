...
public class GcdEuclideanIterativeToCsv {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Write to CSV
        try (PrintWriter writer = new PrintWriter(new FileWriter("gcd_euclidean_iterative_results.csv"))) {
            // Write header
        ...
        System.out.println("✅ CSV file 'gcd_euclidean_iterative_results.csv' generated successfully.");
    }
}
