...
public class GcdSteinRecursiveToCsv {
    ...
    public static BigInteger gcd(BigInteger a, BigInteger b) {
        ...
        if (a.and(BigInteger.ONE).equals(BigInteger.ZERO)) {
            if (b.and(BigInteger.ONE).equals(BigInteger.ONE))
                ...
                return gcd(a.shiftRight(1), b.shiftRight(1)).shiftLeft(1);
        }
        ...
        if (a.compareTo(b) > 0)
            return gcd(a.subtract(b).shiftRight(1), b);
        else
            return gcd(b.subtract(a).shiftRight(1), a);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (PrintWriter writer = new PrintWriter(new FileWriter("gcd_stein_recursive_results.csv"))) {
        ...
        System.out.println("✅ CSV file 'gcd_stein_recursive_results.csv' generated successfully.");
    }
}
